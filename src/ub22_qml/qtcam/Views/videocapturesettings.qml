...
Item {
    ...
    {
        target: root
        function onVideoFrameInterval(frameInterval)
        {
    ...
    {
        target: root
        function onVideoPropertyItemEnable(enableStatus)
        {
    ...
    {
        target: root
        function onVideoChildMenuVisible(visibleStatus)
        {
    ...
    {
        target: root
        function onSetVideoColorComboOutputIndex(isColorCombo, indexValue)
        {
            if(isColorCombo)
            {

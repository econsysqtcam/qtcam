...
Item {
    ...
    Connections
    {
        ...
        function onDisableStillProp(status) //Added by M.VishnuMurali: for disabling still resolution ComboBox and colorspace ComboBox.
        {
    ...
    {
        target:root
        function onStillChildVisibleState(visibleStatus)
        {
    ...
    {
        target: root
        function onStillPropertyItemEnable(enableStatus)
        {
    ...
    {
        target: root
        function onInsertStillImageFormat(stillFormat)
        {
            stillImageFormat = []
    ...
    {
        target: root
        function onSetColorComboOutputIndex(isColorCombo, indexValue)
        {
            if(isColorCombo)
            {

...
Item {
    ...
    Connections{
        ...
        function onFrameSkipCount(stillResolution, videoResolution, stillOutFormat){
            seecam81.setStillSkipCount(stillResolution, videoResolution) // for each resolution skip count will be varied
        }
        function onFrameSkipCountWhenFPSChange(fpsChange){
            seecam81.setStillSkipCountWhenFPSChange(fpsChange)
        }

        function onStillResolutionChanged(stillResolution, stillresolutionIndex, stillFormat, stillFormatIndex){
        ...
        function onManualWbSliderValueChanged(){
            seecam81.getWbValues(See3Cam81.GetRed)
            seecam81.getWbValues(See3Cam81.GetBlue)
            seecam81.getWbValues(See3Cam81.GetGreen)
        }

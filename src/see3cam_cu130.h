...
#define ENABLE_SMILE_TRIGGER_CU130                 0x01
#define DISABLE_SMILE_TRIGGER_CU130                0x00
...
public slots:
    ...
    bool setSmileDetection(bool enableSmileDetect, bool embedData, uint thresholdValue, bool smileTriggerModeValue);

#ifndef SEE3CAM_1332_H
#define SEE3CAM_1332_H
...
#define CAMERA_CONTROL_1332                 0xAE

#define GET_SCENEMODE_1332                  0x01
#define SET_SCENEMODE_1332                  0x02

#define GET_SPECIALEFFECT_1332              0x03
#define SET_SPECIALEFFECT_1332              0x04

#define GET_DENOISE_1332					0x05
#define SET_DENOISE_1332					0x06

#define GET_AF_MODE_1332					0x07
#define SET_AF_MODE_1332					0x08

#define GET_AF_ROI_MODE_1332				0x09
#define SET_AF_ROI_MODE_1332				0x0A

#define GET_EXP_ROI_MODE_1332               0x0B
#define SET_EXP_ROI_MODE_1332               0x0C

#define GET_BURST_LENGTH_1332               0x0D
#define SET_BURST_LENGTH_1332               0x0E

#define GET_HDR_MODE_1332                   0x0F
#define SET_HDR_MODE_1332                   0x10

#define GET_Q_FACTOR_1332                   0x11
#define SET_Q_FACTOR_1332                   0x12

#define ENABLE_DISABLE_MODE_AF_RECTANGLE_1332     0x13
#define ENABLE_AF_RECTANGLE_1332            0x01
#define DISABLE_AF_RECTANGLE_1332           0x00

#define GET_STREAM_MODE_1332                 0x14
#define SET_STREAM_MODE_1332                 0x15

#define GET_AF_RECT_MODE_1332                0x16

#define SET_TO_DEFAULT_1332                  0x17

#define GET_FLIP_MODE_1332                   0x18
#define SET_FLIP_MODE_1332                   0x19

#define SET_FLIP_BOTHFLIP_ENABLE_1332    0x03
#define SET_FLIP_HORZFLIP_1332           0x01
#define SET_FLIP_VERTFLIP_1332           0x02
#define SET_FLIP_BOTHFLIP_DISABLE_1332   0x00
...
#define GET_FRAME_RATE_1332                  0x24
#define SET_FRAME_RATE_1332                  0x25

#define GET_ANTIFLICKER_1332                0x26
#define SET_ANTIFLICKER_1332                0x27

#define ENABLE_DISABLE_AF_RECT               0x30

class See3CAM_1332 : public QObject
{
    Q_OBJECT
...
public:
    explicit See3CAM_1332(QObject *parent = 0);

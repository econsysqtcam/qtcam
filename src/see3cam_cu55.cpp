...
/**
 * @brief See3CAM_CU55::setFlickerDetection - setting flicker control
 * @param flickerMode - Mode we are going to set
 * @return true/false
 */

bool See3CAM_CU55::setFlickerDetection(camFlickerMode flickerMode){
    // hid validation
    if(uvccamera::hid_fd < 0)
    {
        return false;
...
bool See3CAM_CU55::getFlickerDetection()
{
    // hid validation
    if(uvccamera::hid_fd < 0)
    {
